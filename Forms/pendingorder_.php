    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-sm-9">
                ...
                ?>
                        <div class="row order border py-3">
                            <div class="col-sm-2">
                                <?php echo $sno++; ?>
                            </div>
                            ...
                            <div class="col-sm-2" style="align-self: center">
                                ...
                                ?>
                                <a href="https://1699-154-6-26-100.ngrok.io/custom-b2b-app/Forms/pendingorderDetails.php?shop=atacsportwear-com.myshopify.com&id=<?php echo $encryption; ?>">View Order</a>
                            </div>
                        </div>
