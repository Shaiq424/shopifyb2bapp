                                                    ...
                                                    if ($cartdata == 0) {
                                                        ...
                                                        foreach ($variatonData as $variadata) {
                                                            if (in_array($variant->id, $variadata)) {
                                                                $variationsData = 1;
                                                                array_push($allvariationsData, $variationsData);
                                                            } else {
                                                                $variationsData = 0;
                                                             }
                                                        }
        ...
        function art(e) {
            $('.product').each(function() {
                ...
                if ($filenameart[0].files[0] != null) {
                    ...
                    // formData1.append('productid', $productId.val());
                    $.ajax({
                        type: "POST",
